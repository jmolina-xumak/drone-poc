...
public class TraversedListContextProcessor extends AbstractCheckComponentCategoryContextProcessor<TemplateContentModel> {
    ...
    public void process(ExecutionContext executionContext, TemplateContentModel contentModel) throws ProcessException {
        ...
        if (null != contentMap) {
            if (contentMap.containsKey(ROOT_PATH_KEY)) {
                String rootPath = contentMap.get(ROOT_PATH_KEY).toString();

                if (StringUtils.isNotBlank(depth) && StringUtils.isNotBlank(rootPath)) {
                    //TODO continue code logic here
                    LOGGER.info("........1........");
                    LOGGER.info("........2........ depth: " + depth);
                    LOGGER.info("........3........ rootPath: " + rootPath);
                }
            }
        }
    }
